...
$sql ="SELECT Messages.idMess, Produits.nomProduit, Clients.email, Messages.content, Messages.createdAt FROM Produits, Messages, Clients WHERE Messages.toClient = $idClient AND Messages.fromClient = Clients.idClient AND Messages.idProduit = Produits.idProduit ORDER BY Messages.createdAt";
...
$messagesRecu="";
 ...
 foreach($messages as $message){
		 $messagesRecu .= "<tr><td>" . $message['nomProduit'] . "</td><td>" . $message['email'] . "</td><td>" . $message['content'] . "</td><td>" . $message['createdAt'] . "</td>" . '<td><a  href="repondreMessage.php?id='
