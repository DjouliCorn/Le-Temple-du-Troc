...
<div class="container mt-5"  id="afficheDesProduits">
    ...
    $product_array = $dbh->runQuery("SELECT idProduit, nomProduit, url1Image, descProduit FROM Produits, Clients  WHERE Produits.idClient = Clients.idClient AND Clients.idClient = '$client' ORDER BY nomProduit");
    ...
    ?>
            ...
            <div id="grid-item">
				...
				<div id="petitBtn">
					...
					<a href="../produit/supprimerProduit.php?id=<?=$produit['idProduit']; ?>">
						<div>
